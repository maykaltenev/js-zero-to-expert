...
// // console.log(convertTitleCase('and here is another title with an EXAMPLarrFlatE'));
...
// const z = Array.from({ length: 7 }, (_, i) => i + 1);
// console.log(z)
// const arrayOfRolls = Array.from({ length: 100 }, (_) => (Math.floor(Math.random() * 6) + 1))
// console.log(arrayOfRolls);
// labelBalance.addEventListener('click', function () {
//   const movementsUI = Array.from(document.querySelectorAll('.movements__value'),
//     el => Number(el.textContent.replace('€', '')))
//   console.log(movementsUI)
//   const movementsUI2 = [...document.querySelectorAll('.movements__value')]; // now is again an array but the mapping should be done separately
// })
